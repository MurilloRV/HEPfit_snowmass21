...
# model_spec = {
#     "IDM_FCCee240" : "fits",
#     # "IDM_FCCee240_FCCee365" : "fits_full",
#     # "IDM_FCCee240_FCCee365" : "fits_realistic_HL_LHC_no_quad_long",
#     # "IDM_FCCee240_FCCee365" : "fits_realistic_HL_LHC_LoopHd6noWFR_long",
#     # "IDM_FCCee240_FCCee365" : "fits_realistic_HL_LHC_LoopHd6noWFR_no_quad_long",
#     # "IDM_FCCee240_FCCee365" : "fits_realistic_HL_LHC_noLoopH3d6Quad_long",
#     # "IDM_FCCee240_FCCee365" : "fits_realistic_HL_LHC_noLoopH3d6Quad_no_quad_long",
#     # "IDM_FCCee240_FCCee365_HLLHClambda" : "fits_realistic_HL_LHC_realistic_HL_LHC_full",
# }
...
plot_labels = [["BPB 2", "BPB 4", "BPB 6"]]
# plot_labels = [r"$BP_{\kappa_{\lambda} \approx 1}$"]

n_BPs = len(BPs)

# plot_title = r"IDM Central values, FCC-ee$_{240}$ + FCC-ee$_{365}$"
...
for scenario in all_scenarios:
    for BP in BPs:
        for obs in copy_obs:
            ...
            try:
                subprocess.run(["cp", f"{working_dir}{BP_data}/{scenario}/results_{model_spec[scenario]}/Observables/{obs}.pdf",
                        f"{working_dir}comparison_plots/results_{results_dir}/{obs}_{BP}_{scenario}.pdf"])
            except:
                print(f"file not found: {working_dir}{BP_data}/{scenario}/results_{model_spec[scenario]}/Observables/{obs}.pdf")