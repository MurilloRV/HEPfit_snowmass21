...
int main()
{
    ...
    std::vector<Double_t> KappaLambdas;
    ...
    //     "C_{H} fits, ILC_{250} + ILC_{350}",
    //     "C_{H} fits, ILC_{250} + ILC_{350} + ILC_{500}",
    // };

    const std::string base_titles[] = {
        "C_{H} fits, ILC_{250+350} (P_{e^{-}} , P_{e^{+}}) = (#mp80%, #pm30%)",
        "C_{H} fits, ILC_{250+350+500} (P_{e^{-}} , P_{e^{+}}) = (#mp80%, #pm30%)",
    };
