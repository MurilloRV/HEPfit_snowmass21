...
public:
    ...
    static Double_t ShiftX(Double_t x, float xmin, float xmax, float xmin_new, float xmax_new);
    void ShiftAxis(TAxis *a, Double_t (*Shift)(Double_t, float, float, float, float), float xmin, float xmax, float xmin_new, float xmax_new);
    void ShiftXaxis(TH1 *h, Double_t (*Shift)(Double_t, float, float, float, float), float xmin, float xmax, float xmin_new, float xmax_new);
    ...
    void Print_1D_Histos(std::string filepath, 
        ...
        float k_lambda, 
        float k_lambda_err_low=-1.0,
        float k_lambda_err_high=-1.0,
        float k_lambda_range_low=1.0,
        float k_lambda_range_high=-1.0,
        std::string BP_name = "BP"
    );
    


    void setKappaLambda(float KappaLambda, float KappaLambda_err_low, float KappaLambda_err_high, float KappaLambda_range_low, float KappaLambda_range_high)
    {
...
private:
    ...
    float KappaLambda;
    float KappaLambda_err_low;
    float KappaLambda_err_high;
    float KappaLambda_range_low;
    float KappaLambda_range_high;
