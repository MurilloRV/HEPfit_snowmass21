...
Double_t ProcessHistograms::ShiftX(Double_t x, float xmin, float xmax, float xmin_new, float xmax_new)
{
    Double_t shifted_x;
...
void ProcessHistograms::ShiftAxis(TAxis *a, Double_t (*Shift)(Double_t, float, float, float, float), float xmin, float xmax, float xmin_new, float xmax_new)
{
...
void ProcessHistograms::ShiftXaxis(TH1 *h, Double_t (*Shift)(Double_t, float, float, float, float), float xmin, float xmax, float xmin_new, float xmax_new)
{
                                       ...
                                       std::string BP_name)
{
    ...
    const std::string draw_args = "HIST";
    ...
    if (hist_title == "deltalHHH_HLLHC") {
        ...
        if (drawKappaLambdaLine) {
            kappa_line = new TLine(KappaLambda-1, 0., KappaLambda-1, 1.4*bch1d.GetHistogram()->GetMaximum());
            ...
            TLegendEntry* leg_line = bch1d.AddLegendEntry(kappa_line, "True SMEFT value (#kappa_{#lambda}="+KappaLambda_str+")", "L");
...
void ProcessHistograms::Print_1D_Histos(std::string filepath,
                                        ...
                                        std::string title,
                                        float k_lambda,
                                        float k_lambda_err_low,
                                        float k_lambda_err_high,
                                        float k_lambda_range_low,
                                        float k_lambda_range_high,
                                        std::string BP_name)
{
