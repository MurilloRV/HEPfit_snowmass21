...
output_file_FCCee240 = "ObservablesHiggs_FCCee_240_SM_kappa_scaled_SQUARED.conf"
    ...
    for line in infile:
        if line.startswith("Observable"):
            ...
            if (columns[1].startswith("eeZH_")):
                ...
                columns[8] = str(kappas2["ZZ"]*kappas2["Zgam"]*float(columns[8])/kappas2["H"])
                columns[9] = str(kappas2["ZZ"]*kappas2["Zgam"]*float(columns[9])/kappas2["H"])
...
output_file_FCCee365 = "ObservablesHiggs_FCCee_365_kappa_scaled_SQUARED.conf"
