...
def find_tex_label_obs(obs):
    ### ILC_250
    if obs == "eeZH_ILC250_m80_p30":         tex_label = r"$\sigma_{ZH}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHbb_ILC250_m80_p30":     tex_label = r"$\mu_{ZH,bb}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeHvvbb_ILC250_m80_p30":    tex_label = r"$\mu_{\nu\nu H,bb}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHcc_ILC250_m80_p30":     tex_label = r"$\mu_{ZH,cc}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHgg_ILC250_m80_p30":     tex_label = r"$\mu_{ZH,gg}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHWW_ILC250_m80_p30":     tex_label = r"$\mu_{ZH,WW}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHtautau_ILC250_m80_p30": tex_label = r"$\mu_{ZH,\tau\tau}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHZZ_ILC250_m80_p30":     tex_label = r"$\mu_{ZH,ZZ}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHgaga_ILC250_m80_p30":   tex_label = r"$\mu_{ZH,\gamma\gamma}^{-80\%,30\%}$(ILC$_{250}$)"
    elif obs == "eeZHmumu_ILC250_m80_p30":   tex_label = r"$\mu_{ZH,\mu\mu}^{-80\%,30\%}$(ILC$_{250}$)"

    elif obs == "eeZH_ILC250_p80_m30":       tex_label = r"$\sigma_{ZH}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHbb_ILC250_p80_m30":     tex_label = r"$\mu_{ZH,bb}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeHvvbb_ILC250_p80_m30":    tex_label = r"$\mu_{\nu\nu H,bb}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHcc_ILC250_p80_m30":     tex_label = r"$\mu_{ZH,cc}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHgg_ILC250_p80_m30":     tex_label = r"$\mu_{ZH,gg}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHWW_ILC250_p80_m30":     tex_label = r"$\mu_{ZH,WW}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHtautau_ILC250_p80_m30": tex_label = r"$\mu_{ZH,\tau\tau}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHZZ_ILC250_p80_m30":     tex_label = r"$\mu_{ZH,ZZ}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHgaga_ILC250_p80_m30":   tex_label = r"$\mu_{ZH,\gamma\gamma}^{80\%,-30\%}$(ILC$_{250}$)"
    elif obs == "eeZHmumu_ILC250_p80_m30":   tex_label = r"$\mu_{ZH,\mu\mu}^{80\%,-30\%}$(ILC$_{250}$)"
...
# scenarios = ["Z2SSM_noHLLHClambda",
#              "Lambda2_noHLLHClambda",
#              "Lambda3_noHLLHClambda",
#              "Lambda5_noHLLHClambda",
#              "Lambda10_noHLLHClambda",
#             ]

scenarios = ["Z2SSM_HLLHClambda",
             "Lambda2_HLLHClambda",
             "Lambda3_HLLHClambda",
             "Lambda5_HLLHClambda",
...
# plot_titles = [r"Z2SSM Central values, with HL-LHC $\lambda_{hhh}$ constraint",
#                r"$\kappa_\lambda=2$ cross-check, no HL-LHC $\lambda_{hhh}$ constraint",
#                r"$\kappa_\lambda=3$ cross-check, no HL-LHC $\lambda_{hhh}$ constraint",
#                r"$\kappa_\lambda=5$ cross-check, no HL-LHC $\lambda_{hhh}$ constraint",
#                r"$\kappa_\lambda=10$ cross-check, no HL-LHC $\lambda_{hhh}$ constraint",
#               ]
...
plot_labels = [r"$\mathbb{Z}_{2}$SSM, with $\kappa_\lambda$",
               r"$\kappa_\lambda=2$ cross-check",
               r"$\kappa_\lambda=3$ cross-check",
               r"$\kappa_\lambda=5$ cross-check",
               r"$\kappa_\lambda=10$ cross-check",
...
for k in range(len(param_breaks) - 1):
    ...
    plt.savefig(working_dir + f'comparison_plots/results_{model_spec}/withHLLHC_mean_stddev_{k}.pdf')
...
scenarios = ["Lambda2_noHLLHClambda",
             "Lambda3_noHLLHClambda",
             "Lambda5_noHLLHClambda",
             "Lambda10_noHLLHClambda",
             "Lambda2_HLLHClambda",
...
for scenario in scenarios:
    for obs in copy_obs:
        subprocess.run(["cp", f"{working_dir}{scenario}/results_{model_spec}/Observables/{obs}.pdf",
                    ...
                    f"{working_dir}comparison_plots/results_{model_spec}/withHLLHC_{obs}_{scenario}.pdf"])