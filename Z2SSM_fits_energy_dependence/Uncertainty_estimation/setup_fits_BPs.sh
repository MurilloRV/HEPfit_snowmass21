...
ORIGINAL_PATH="/cephfs/user/mrebuzzi/phd/HEPfit/HEPfit_snowmass21/Z2SSM_fits_energy_dependence/Uncertainty_estimation"
...
for ((i=0; i<${#CH_values[@]}; i++)); do
    ...
    SCENARIO_PATH="CH_CHbox_BPs_${i}_FCCee240_FCCee365"
