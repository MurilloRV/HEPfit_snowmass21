...
plot_titles = [r"SM Central values, no HL-LHC $\lambda_{hhh}$ constraint",
          ...
          r"IDM Central values, no HL-LHC $\lambda_{hhh}$ constraint",
          r"IDM Central values, with HL-LHC $\lambda_{hhh}$ constraint",
          ]
plot_labels = [r"SM, no $\kappa_\lambda$",
               r"SM, with $\kappa_\lambda$",
               r"IDM, no $\kappa_\lambda$",
               r"IDM, with $\kappa_\lambda$",
               ]
