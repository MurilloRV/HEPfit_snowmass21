...
void ProcessHistograms::ShiftXaxis(TH1D *h, Double_t (*Shift)(Double_t, Double_t, Double_t, Double_t, Double_t), Double_t xmin, Double_t xmax, Double_t xmin_new, Double_t xmax_new)
{
                                       ...
                                       std::string BP_name)
{
    ...
    if (hist_title == "deltalHHH_HLLHC") {
        ...
        if (drawKappaLambdaLine) {
            ...
            TLegendEntry* leg_line = bch1d.AddLegendEntry(kappa_line, "Z2SSM "+BP_name+" value (#kappa_{#lambda}="+KappaLambda_str+")", "L");
